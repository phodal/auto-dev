...
public class NanoDSLStateBlockImpl extends ASTWrapperPsiElement implements NanoDSLStateBlock {

  public NanoDSLStateBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public NanoDSLStateEntries getStateEntries() {
    return findNotNullChildByClass(NanoDSLStateEntries.class);
  }
