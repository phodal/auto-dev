...
public class NanoDSLRequestBlockImpl extends ASTWrapperPsiElement implements NanoDSLRequestBlock {

  public NanoDSLRequestBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public NanoDSLRequestEntries getRequestEntries() {
    return findNotNullChildByClass(NanoDSLRequestEntries.class);
  }
