...
public class NanoDSLRequestEntryImpl extends ASTWrapperPsiElement implements NanoDSLRequestEntry {

  public NanoDSLRequestEntryImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NanoDSLVisitor visitor) {
    visitor.visitRequestEntry(this);
  }
