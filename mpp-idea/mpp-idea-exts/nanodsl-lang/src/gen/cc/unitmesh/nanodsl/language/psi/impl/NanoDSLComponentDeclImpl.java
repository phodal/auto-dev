...
public class NanoDSLComponentDeclImpl extends ASTWrapperPsiElement implements NanoDSLComponentDecl {

  public NanoDSLComponentDeclImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public NanoDSLComponentBody getComponentBody() {
    return findNotNullChildByClass(NanoDSLComponentBody.class);
  }

  @Override
  @Nullable
  public NanoDSLParamList getParamList() {
    return findChildByClass(NanoDSLParamList.class);
  }
