...
public class NanoDSLComponentInstancesImpl extends ASTWrapperPsiElement implements NanoDSLComponentInstances {

  public NanoDSLComponentInstancesImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NanoDSLVisitor visitor) {
    visitor.visitComponentInstances(this);
  }
