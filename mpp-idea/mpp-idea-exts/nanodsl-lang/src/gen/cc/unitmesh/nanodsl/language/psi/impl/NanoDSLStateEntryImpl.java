...
public class NanoDSLStateEntryImpl extends ASTWrapperPsiElement implements NanoDSLStateEntry {

  public NanoDSLStateEntryImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NanoDSLVisitor visitor) {
    visitor.visitStateEntry(this);
  }
  ...
  @Override
  @NotNull
  public NanoDSLTypeRef getTypeRef() {
    return findNotNullChildByClass(NanoDSLTypeRef.class);
  }
