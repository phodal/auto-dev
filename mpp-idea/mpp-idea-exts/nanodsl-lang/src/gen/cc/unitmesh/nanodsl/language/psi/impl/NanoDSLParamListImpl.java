...
public class NanoDSLParamListImpl extends ASTWrapperPsiElement implements NanoDSLParamList {

  public NanoDSLParamListImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<NanoDSLParam> getParamList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, NanoDSLParam.class);
  }
