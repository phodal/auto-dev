...
public class NanoDSLComponentNameImpl extends ASTWrapperPsiElement implements NanoDSLComponentName {

  public NanoDSLComponentNameImpl(@NotNull ASTNode node) {
    super(node);
  }
